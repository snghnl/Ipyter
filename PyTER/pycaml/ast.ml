(* Clone code of https://github.com/hakjoooh/PyIR/blob/main/frontend/ast.ml *)
...
and attributes = { mutable lineno: int ; mutable col_offset: int ; end_lineno: int option ; end_col_offset: int option} 
